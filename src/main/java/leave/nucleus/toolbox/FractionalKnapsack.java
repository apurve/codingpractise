...
public class FractionalKnapsack {
    ...
    /*public static void main(String args[]) {
        int n = 3;
        BigDecimal capacity = BigDecimal.valueOf(50);
        List<Item> items = new ArrayList<Item>();
        items.add(new Item(BigDecimal.valueOf(60), BigDecimal.valueOf(20)));
        items.add(new Item(BigDecimal.valueOf(100), BigDecimal.valueOf(50)));
        items.add(new Item(BigDecimal.valueOf(120), BigDecimal.valueOf(30)));
        System.out.println(getOptimalValue(capacity, items));
    }*/
